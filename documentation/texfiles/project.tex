...
%% Change these:
\newcommand{\projecttitle}{Heap-Overflow}
\newcommand{\projectauthor}{Arnas Steponavicius \\ Github: https://github.com/ArnasSteponavicius00/heap-overflow
Deployed Website: https://heap-overflow-fyp.netlify.app/}
\newcommand{\projectadvisor}{Dr Andrew Beatty}
